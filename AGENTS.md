...
| 최혜리 | QA/Security | Minimal-collection/encryption, guardrail validation, primary web-push delivery + permission-denied failure path ([ADR-0005](docs/adr/0005-webpush-primary-channel.md)), E2E testing, demo material |
